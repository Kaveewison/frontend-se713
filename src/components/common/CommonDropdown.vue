...
<template>
    <div class="form-group" :class="{ 'has-error': hasError }">
        ...
        <div class="custom-select" :class="{ 'select-error': hasError, 'has-icon': !!icon }">
            <component v-if="icon" :is="icon" class="select-icon-left" :size="17" :stroke-width="2" />

            <select :id="id" :value="modelValue" :disabled="disabled" :required="required" @change="handleChange"
                @blur="handleBlur">
